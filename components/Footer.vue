<template>
  <footer class="w-full dark:bg-slate-900 min-h-80">
    <article class="min-h-80 w-full relative my-0 mx-auto overflow-hidden">
      <article id="lightings" class="absolute -bottom-16 w-full">
        <section id="one">
          <section id="two">
            <section id="three">
              <section id="four">
